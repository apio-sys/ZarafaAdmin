...
<xsl:template match="/zarafaadmin/system">
  ...
  <tr class="hover"><td>Time when the server was started</td><td><xsl:value-of select="@server_start_date"/></td></tr>
  <tr class="hover"><td>Time when the cache was cleared</td><td><xsl:value-of select="@cache_purge_date"/></td></tr>
  <tr class="hover"><td>Time when the configuration file was reloaded / logrotation (SIGHUP) </td><td><xsl:value-of select="@config_reload_date"/></td></tr>
  ...
  <tr class="hover"><td>Timestamp of last failed SQL command </td><td><xsl:value-of select="@sql_last_fail_time"/></td></tr>
  ...
  <tr class="hover"><td>Number of sessions </td><td><xsl:value-of select="@sessions"/></td></tr>
  ...
  <tr class="hover"><td>Number of threads running to process items </td><td><xsl:value-of select="@threads"/></td></tr>
  <tr class="hover"><td>Number of idle threads </td><td><xsl:value-of select="@threads_idle"/></td></tr>
  <tr class="hover"><td>Number of allowed users</td><td><xsl:value-of select="@usercnt_licensed"/></td></tr>
  <tr class="hover"><td>Number of active users </td><td><xsl:value-of select="@usercnt_active"/></td></tr>
  <tr class="hover"><td>Number of total non-active objects </td><td><xsl:value-of select="@usercnt_nonactive"/></td></tr>
