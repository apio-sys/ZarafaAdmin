#!/usr/bin/env python
"""
Python wrapper for zarafa-stats
"""
...
args['version'] = 0.1
encoding = 'utf-8'
command = '/usr/bin/zarafa-stats'

headers = {}
headers['users'] = ['company','username','fullname','emailaddress','active','admin','UNK0x67C1001E','size','quotawarn','quotasoft','quotahard','UNK0x67200040','UNK0x6760000B','logon','logoff']
...
if __name__ == "__main__":
    ...
    if args['output'] != 'text': command += " --dump"
    ...
    if args['output'] == 'text':
        ...
        print ";".join(headers[args['command']])
        print "\n".join(out.split('\n')[1:])
    else:
