...
<xsl:when test="count(device) = 1">
  ...
  <tr class="hover"><th>Device ID</th><td><xsl:value-of select="device/@deviceid"/></td><th>Request By</th><td><xsl:value-of select="wipe/@wiperequestby"/></td></tr>
  ...
  <tr><td>&#xA0;</td><td><table id="z-push-errors">
...
<xsl:otherwise>
  ...
  <table id="z-push-devices">
  <tr>
    <th><a href="./z-push-details.php?user={$user}&amp;sort=username">Username</a></th>
    <th><a href="./z-push-details.php?user={$user}&amp;sort=device">Device ID</a></th>
    <th><a href="./z-push-details.php?user={$user}&amp;sort=sync">Last Sync</a></th>
  </tr>
    <xsl:choose>
    ...
    <tr><td class="hover" colspan="3">No devices found!</td></tr>
    </xsl:if>
  </table>
